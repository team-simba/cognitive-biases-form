                ...
                <SecurityContext
                    ...
                    content={
                        ...
                        <p>
                            ...
                            <br />
                           הצבת מסגרת זמן של 60 יום קובעת עוגן מספרי שהדיון, הציפיות וההערכות של הצדדים נעים סביבו. גם אם תהיה סטייה – היא לרוב תהיה קרובה לעוגן (למשל 50 או 70 יום), ולא רחוקה ממנו באופן קיצוני.
